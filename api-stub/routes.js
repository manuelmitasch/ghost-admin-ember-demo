module.exports = function(server) {
  ...
  // have to be repeated for each end point.
	server.namespace('/ghost/api/v0.1', function() {

		// Return fixture data for '/api/posts'
		...
		// Return fixture data for '/api/posts/1'
		server.get('/posts/1', function(req, res) {
			var post = {
	      "id": 1,
	      "uuid": "4b96025d-050c-47ff-8bd4-047e4843b302",
	      "title": "Welcome to Ghost",
		...
		// Return fixture data for '/api/posts/2'
		server.get('/posts/2', function(req, res) {
			var post = {
	      "id": 2,
	      "uuid": "4dc16b9e-bf90-44c9-97c5-40a0a81e8297",
	      "title": "Ghost Ember Demo Post",
